...
LeftMenu.load()
mouseHandler.onClick(".show_menu",()=>LeftMenu.toggle());LeftMenu.onResize();if("serviceWorker"in navigator){let scriptElement=document.getElementById("service-worker-script");if(scriptElement){navigator.serviceWorker.register(scriptElement.src);}}});})();`,
...
var JavascriptsChecksums = map[string]string{
	"app": "bb7e3d6dd7f1072a95d5fe56808e9945ec5a610c1eaaecbc1992d203ebafa872",
